...
import { BookOpen, Shield, Users, GraduationCap, Mail, AlertCircle, RefreshCw } from 'lucide-react'
...
const Login = () => {
  ...
  useEffect(() => {
    // Initialize Google Sign-In button with error handling
          ...
          >
            ...
            {error && (
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-red-900 dark:text-red-300">Sign In Error</h4>
            ...
            >
              <div 
                ...
                className={`flex justify-center min-h-[48px] ${isLoading ? 'opacity-50' : ''}`}
              />
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center space-x-3 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-lg px-6 py-3 text-gray-700 dark:text-gray-300 font-medium hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              {error && (
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200"
                >
