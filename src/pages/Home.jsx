...
const Home = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 transition-colors duration-300">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 text-sm"
              >
              ...
              >
                ...
                >
                  ...
                  >
                    <Rocket className="w-8 h-8 lg:w-10 lg:h-10 ml-2" />
                  </motion.div>
                </motion.span>
              </motion.h1>
              ...
              <motion.p
                ...
                className="text-lg sm:text-xl lg:text-2xl mb-8 text-blue-100 leading-relaxed max-w-2xl mx-auto lg:mx-0"
              >
              ...
              >
                <Link to="/semesters" className="group relative overflow-hidden bg-white text-blue-600 font-bold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-2xl text-center">
            ...
            >
              <div className="relative">
                      ...
                      return (
                        ...
                        >
                          <motion.div
                            ...
                            className="bg-white/20 rounded-2xl p-4 lg:p-6 text-center hover:bg-white/30 transition-colors duration-300 group-hover:scale-105"
                          >
                            <div className={`w-10 h-10 lg:w-12 lg:h-12 ${item.color} rounded-xl flex items-center justify-center mx-auto mb-3`}>
                              <Icon className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
                            </div>
                            <p className="text-white font-medium text-sm lg:text-base">{item.title}</p>
                ...
                <motion.div
                  ...
                  className="absolute -top-8 -right-8 w-16 h-16 lg:w-24 lg:h-24 bg-yellow-400/30 rounded-full blur-xl"
                />
                ...
                <motion.div
                  ...
                  className="absolute -bottom-12 -left-12 w-20 h-20 lg:w-32 lg:h-32 bg-pink-400/20 rounded-full blur-2xl"
                />
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 lg:py-20 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 transition-colors duration-300">
      ...
      <section className="py-16 lg:py-20 bg-white dark:bg-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-800 dark:text-white mb-6">
      ...
      <section className="py-16 lg:py-20 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-800 relative overflow-hidden">
      ...
      {/* CTA Section */}
      <section className="py-16 lg:py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-800 relative overflow-hidden">
        <div className="absolute inset-0">
          <motion.div
            animate={{
              scale: [1, 1.2, 1],
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="flex items-center justify-center space-x-3 mb-6">
              ...
              <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white text-center">
