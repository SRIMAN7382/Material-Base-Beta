      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Share knowledge and help fellow students succeed</p>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Your contributions will be credited and appreciated</p>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Create a lasting impact for future students</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 lg:p-8">
            ...
            <p className="text-indigo-100 mt-2">Fill in the details below to contribute your materials</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 lg:p-8 space-y-8">
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`flex-1 flex items-center justify-center space-x-3 py-4 px-8 rounded-2xl font-bold text-lg shadow-xl transition-all duration-300 ${
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white rounded-2xl font-medium transition-all duration-200"
              >
                Reset Form
              </motion.button>
            </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="font-semibold text-lg text-gray-800 dark:text-white mb-4">File Requirements:</h4>
            ...
            <div>
              <h4 className="font-semibold text-lg text-gray-800 dark:text-white mb-4">Content Guidelines:</h4>
              <ul className="space-y-2 text-gray-600 dark:text-gray-300">
